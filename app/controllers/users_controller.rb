class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:id, :email, :username, :first_name, :last_name, :age, :address, :profile_image, :city, :gender, :latitude, :longitude, :provider, :uid, :is_admin, :marital_status, :race, :state)
    end
end
