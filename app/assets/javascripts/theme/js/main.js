...
$(document).ready(function() {
  ...
  $.validator.addMethod("alphanumeric", function(value, element) {
    return this.optional(element) || /^[a-zA-Z0-9]+$/.test(value) && /\d/.test(value);
  ...
  $('#sign_up_user').validate({
    rules: {
      ...
      "user[username]": { required: true, remote:'/users/sessions/check_email_registration', minlength: 8, alphanumeric: true },
